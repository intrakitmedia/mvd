        ...
        <div class="container">
            ...
            <div class="row blog-card post-card case-card">
                <div class="two-col">
                    <div class="blog-card-image-wapper">
                        <div class="blog-featured-image"
                             style="background: url(@asset('images/case-study-two.jpg')); background-size:cover;">
                        </div>
                    </div>
                </div>
                <div class="two-col">
                    <div class="blog-content-card top-news">
                        <div class="blog-roll-header blog-card-row">
                            ...
                            <div class="blog-roll-title">
                                <h3><a href="">How a 70 Yr Manufacturing Co. Closes Sales with B2B Video Production</a></h3>
                            </div>
                        </div>
                        <div class="blog-roll-body blog-card-row">
                            <p>Just like animated videos for business are highly effective to convert leads, animated holiday cards as they make a memorable impression on their customers and prospects.  So, if your goal…</p>
            ...
            <div class="row blog-card post-card case-card">
                <div class="two-col">
                    <div class="blog-card-image-wapper">
                        <div class="blog-featured-image"
                             style="background: url(@asset('images/case-study-three.jpg')); background-size:cover;">
                        </div>
                    </div>
                </div>
                <div class="two-col">
                    <div class="blog-content-card top-news">
                        <div class="blog-roll-header blog-card-row">
                            ...
                            <div class="blog-roll-title">
                                <h3><a href="">The 4 Day Manufacturing Video Production Deliverable – Making it Happen for the Haydon Corporation</a></h3>
                            </div>
                        </div>
                        <div class="blog-roll-body blog-card-row">
                            <p>Just like animated videos for business are highly effective to convert leads, animated holiday cards as they make a memorable impression on their customers and prospects.  So, if your goal…</p>
            ...
            <div class="row blog-card post-card case-card">
                <div class="two-col">
                    <div class="blog-card-image-wapper">
                        <div class="blog-featured-image"
                             style="background: url(@asset('images/case-study-four.jpg')); background-size:cover;">
                        </div>
                    </div>
                </div>
                <div class="two-col">
